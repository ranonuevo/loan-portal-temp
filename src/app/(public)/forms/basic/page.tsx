...
export default function Page() {
  ...
  const toggleDisableFields = (val: boolean | any[]) => {
    setValue('isDisableFields', Boolean(val))
  }
                ...
                <FormItem>
                  <FormControl>
                    <CheckBox 
                      ...
                      hasError={!!hookForm.formState.errors.agree}
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <DropDown 
                      {...field} 
                      disabled={isDisableFields}
                      hasError={!!hookForm.formState.errors.countries}
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <CheckBox 
                      {...field} 
                      disabled={isDisableFields}
                      hasError={!!hookForm.formState.errors.ingredients}
                      options={[
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <RadioGroup 
                      {...field} 
                      disabled={isDisableFields}
                      hasError={!!hookForm.formState.errors.purpose}
                      options={[
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea 
                      {...field} 
                      disabled={isDisableFields}
                      hasError={!!hookForm.formState.errors.feedback}
